...
export function useMorphButton(state: SubmitState, idleContent: ReactNode) {
  ...
  const morphStyle: CSSProperties = {
    ...
    backgroundColor:
      state === "success" ? stateBackgroundColors.success
      : state === "error" ? stateBackgroundColors.error
      : undefined,
    color: state === "idle" ? undefined : "#ffffff",
    transition:
  ...
  const morphContent: ReactNode =
    ...
    : state === "loading" ? createElement("svg", { className: "animate-spin", viewBox: "0 0 24 24", fill: "none", width: 22, height: 22 },
        ...
        createElement("path", { d: "M12 3a9 9 0 0 1 9 9", stroke: "#ffffff", strokeWidth: "2.5", strokeLinecap: "round" })
      )
    : state === "success" ? createElement("svg", { viewBox: "0 0 24 24", fill: "none", width: 22, height: 22 },
        createElement("path", { d: "M5 13l4 4L19 7", stroke: "#ffffff", strokeWidth: "2.5", strokeLinecap: "round", strokeLinejoin: "round" })
      )
    : createElement("svg", { viewBox: "0 0 24 24", fill: "none", width: 22, height: 22 },
        createElement("path", { d: "M8 8l8 8M16 8l-8 8", stroke: "#ffffff", strokeWidth: "2.5", strokeLinecap: "round" })
      );
