...
import { Eye, EyeOff, Mail, Lock, User, Building2, AlertCircle, CheckCircle, Moon, Sun } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-sidebar to-background flex flex-col items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-sm">
        {/* Logo */}
        <div className="text-center mb-8 max-w-64 mx-auto">
          <div
        ...
        <p className="text-center text-muted-foreground/50 text-xs mt-6">© 2026 Mobile2Screen · v1.0</p>
      </div>
    </div>
  );
}
